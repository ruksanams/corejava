...
public class JavaUtilDateExample
{
   ...
   public static void main(String args[])
   {
	...
	int comparisson = d1.compareTo(d2);    // d1 > d2
	int comparisson2 = d2.compareTo(d1);  // d2 > d1
	int comparisson3 = d1.compareTo(d1);  // d1 = d2
	System.out.println("d1 > d2 : "+comparisson);
	System.out.println("d2 > d1 : "+comparisson2);
	System.out.println("d1 = d2 : "+comparisson3);
	System.out.println("");
